...
*/
public class SToggleSVGButton extends androidx.appcompat.widget.AppCompatToggleButton {
    private OnCheckedStateListenner mOnCheckedStateListenner;

    public SToggleSVGButton(Context context) {
        this(context, null);
    }

    public SToggleSVGButton(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SToggleSVGButton(Context context, AttributeSet attrs, int defStyleAttr) {
