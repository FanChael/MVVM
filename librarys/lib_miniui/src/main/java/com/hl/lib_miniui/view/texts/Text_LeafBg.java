...
public class Text_LeafBg extends androidx.appcompat.widget.AppCompatTextView {
    private int text_color, bg_color;
    private int text_size;
    private int shape_color;

    public Text_LeafBg(Context context) {
        super(context);
        init(context, null);
    }

    public Text_LeafBg(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public Text_LeafBg(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        setBackground(ShapeUtil.createShape(
                -1,
                new float[]{DensityUtil.dip2px(context, 9), 0,
                        DensityUtil.dip2px(context, 11), 0},
                -1, null, bg_color));
