package com.hl.lib_media.example;
...
public class MediaApplication extends Application implements IAppComponent {
    private static final String TAG = MediaApplication.class.getName();
