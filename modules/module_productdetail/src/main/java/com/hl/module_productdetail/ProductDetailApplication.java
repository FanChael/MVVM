package com.hl.module_productdetail;
...
public class ProductDetailApplication extends Application implements IAppComponent {
    private static final String TAG = ProductDetailApplication.class.getName();
